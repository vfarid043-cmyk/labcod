import { LemonadConfig, LemonadTheme, LEMONAD_LANGUAGES, getDefaultLemonadConfig } from "@/types/lemonad";
...
const THEME_OPTIONS: { value: LemonadTheme; label: string; description: string }[] = [
...
interface LemonadConfigPanelProps {
  config: LemonadConfig;
  language: string;
  updateConfig: (updates: Partial<LemonadConfig>) => void;
  onLanguageChange: (language: string) => void;
}

export function LemonadConfigPanel({
  config,
  language,
  updateConfig,
  onLanguageChange,
}: LemonadConfigPanelProps) {
  const handleLanguageChange = (newLanguage: string) => {
    onLanguageChange(newLanguage);
    const newDefaults = getDefaultLemonadConfig(newLanguage);
    updateConfig({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Platform Header */}
      <div className="p-4 border-b border-border bg-gradient-to-r from-yellow-600/10 to-orange-600/10">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-6 h-6 bg-yellow-500 rounded flex items-center justify-center text-white text-xs font-bold">
            LM
          </div>
          <span className="font-semibold text-sm">Lemonad</span>
        </div>
        
        <Label className="text-muted-foreground text-xs mb-2 block">Idioma / GEO</Label>
        <Select value={language} onValueChange={handleLanguageChange}>
          <SelectTrigger className="bg-secondary/50 border-border">
            <SelectValue />
          </SelectTrigger>
          <SelectContent className="bg-card border-border">
            {Object.values(LEMONAD_LANGUAGES).map((lang) => (
      ...
      <Tabs defaultValue="api" className="flex-1 flex flex-col">
        <TabsList className="mx-4 mt-4 grid grid-cols-5 bg-secondary/50">
          <TabsTrigger value="api" className="data-[state=active]:bg-yellow-500 data-[state=active]:text-white">
            <Key className="w-4 h-4" />
          </TabsTrigger>
          <TabsTrigger value="visual" className="data-[state=active]:bg-yellow-500 data-[state=active]:text-white">
            <Palette className="w-4 h-4" />
          </TabsTrigger>
          <TabsTrigger value="features" className="data-[state=active]:bg-yellow-500 data-[state=active]:text-white">
            <Clock className="w-4 h-4" />
          </TabsTrigger>
          <TabsTrigger value="thankyou" className="data-[state=active]:bg-yellow-500 data-[state=active]:text-white">
            <Gift className="w-4 h-4" />
          </TabsTrigger>
          <TabsTrigger value="upsell" className="data-[state=active]:bg-yellow-500 data-[state=active]:text-white">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          ...
          <TabsContent value="api" className="p-4 space-y-4 mt-0">
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-yellow-400 flex items-center gap-2">
                <Key className="w-4 h-4" />
                Configurações da API Lemonad
              </h3>
              
              <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">Webmaster Token</Label>
                <Input
                  value={config.webmasterToken}
                  onChange={(e) => updateConfig({ webmasterToken: e.target.value })}
                  placeholder="Seu token Lemonad"
              ...
              <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">Cost (Valor)</Label>
                <Input
                  type="number"
                  value={config.cost}
                  onChange={(e) => updateConfig({ cost: parseInt(e.target.value) || 0 })}
                  placeholder="0"
                  className="bg-secondary/50 border-border"
                />
              </div>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-yellow-400">Dimensões do Formulário</h3>
          ...
          <TabsContent value="visual" className="p-4 space-y-4 mt-0">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-yellow-400">Conteúdo do Formulário</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-yellow-400">Cores</h3>

              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  <Label className="text-muted-foreground text-xs">Cor Primária</Label>
              ...
              <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">Formato do Botão</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-card border-border">
                    <SelectItem value="small">Quadrado</SelectItem>
                    <SelectItem value="medium">Arredondado</SelectItem>
                    <SelectItem value="large">Mais Arredondado</SelectItem>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateConfig({ salesCount: parseInt(e.target.value) || 0 })}
                      className="bg-secondary/50 border-border"
                    />
                  </div>
                </div>
          ...
          <TabsContent value="thankyou" className="p-4 space-y-4 mt-0">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-yellow-400">Cores da Página</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-yellow-400">Detalhes do Pedido</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-yellow-400">Imagem do Produto</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-yellow-400">Texto Final</h3>
            ...
            <div className="space-y-4">
              ...
              {config.showUpsell && (
                <>
                  ...
                  <h4 className="text-sm font-semibold text-yellow-400">Cores do Upsell</h4>
                  ...
                  <h4 className="text-sm font-semibold text-yellow-400">Imagem do Upsell</h4>
