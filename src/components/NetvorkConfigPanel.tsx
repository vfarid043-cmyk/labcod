import { NetvorkConfig, NetvorkTheme, NETVORK_LANGUAGES, getDefaultNetvorkConfig } from "@/types/netvork";
...
const THEME_OPTIONS: { value: NetvorkTheme; label: string; description: string }[] = [
...
interface NetvorkConfigPanelProps {
  config: NetvorkConfig;
  language: string;
  updateConfig: (updates: Partial<NetvorkConfig>) => void;
  onLanguageChange: (language: string) => void;
}

const NETVORK_LANGUAGE_OPTIONS = Object.values(NETVORK_LANGUAGES);

export function NetvorkConfigPanel({ config, language, updateConfig, onLanguageChange }: NetvorkConfigPanelProps) {
  const handleLanguageChange = (languageCode: string) => {
    const newDefaults = getDefaultNetvorkConfig(languageCode);
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-b border-border bg-gradient-to-r from-purple-600/10 to-pink-600/10">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-semibold text-sm">Netvork</span>
        </div>
        ...
        <Select value={language} onValueChange={handleLanguageChange}>
          ...
          <SelectContent className="bg-card border-border">
            {NETVORK_LANGUAGE_OPTIONS.map((lang) => (
      ...
      <Tabs defaultValue="api" className="flex-1 flex flex-col">
        <TabsList className="mx-4 mt-4 grid grid-cols-5 bg-secondary/50">
          <TabsTrigger value="api" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white">
          ...
          <TabsTrigger value="thankyou" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white">
            <Gift className="w-4 h-4" />
          </TabsTrigger>
          <TabsTrigger value="upsell" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          ...
          <TabsContent value="api" className="p-4 space-y-4 mt-0">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">Seu token de API da Netvork</p>
              </div>
              ...
              <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">Idioma (lang)</Label>
                <Input
                  value={config.lang}
                  onChange={(e) => updateConfig({ lang: e.target.value })}
                  placeholder="Ex: ro, pt, pl, ru"
                  className="bg-secondary/50 border-border"
                />
                <p className="text-xs text-muted-foreground">Código do idioma para API</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  <Label className="text-muted-foreground text-xs">utm_source</Label>
                  <Input
                    value={config.utmSource}
                    onChange={(e) => updateConfig({ utmSource: e.target.value })}
                    placeholder="facebook"
                    className="bg-secondary/50 border-border"
                  />
                </div>
                <div className="space-y-2">
                  <Label className="text-muted-foreground text-xs">utm_medium</Label>
                  <Input
                    value={config.utmMedium}
                    onChange={(e) => updateConfig({ utmMedium: e.target.value })}
                    placeholder="cpc"
                    className="bg-secondary/50 border-border"
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  <Label className="text-muted-foreground text-xs">utm_campaign</Label>
                  <Input
                    value={config.utmCampaign}
                    onChange={(e) => updateConfig({ utmCampaign: e.target.value })}
                    placeholder="promo2024"
                    className="bg-secondary/50 border-border"
                  />
                </div>
                <div className="space-y-2">
                  <Label className="text-muted-foreground text-xs">utm_content</Label>
                  <Input
                    value={config.utmContent}
                    onChange={(e) => updateConfig({ utmContent: e.target.value })}
                    placeholder="banner1"
                    className="bg-secondary/50 border-border"
                  />
                </div>
              ...
              <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">utm_term</Label>
                <Input
                  value={config.utmTerm}
                  onChange={(e) => updateConfig({ utmTerm: e.target.value })}
                  placeholder="keyword"
                  className="bg-secondary/50 border-border"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Label className="text-muted-foreground text-xs">Mostrar Select de País</Label>
                <Switch
                  checked={config.showCountrySelect}
                  onCheckedChange={(checked) => updateConfig({ showCountrySelect: checked })}
                />
              </div>

              <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">País Padrão</Label>
                <Input
                  value={config.defaultCountry}
                  onChange={(e) => updateConfig({ defaultCountry: e.target.value })}
                  placeholder="RO"
                  className="bg-secondary/50 border-border"
                />
              </div>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-purple-400">Dimensões do Formulário</h3>
          ...
          <TabsContent value="visual" className="p-4 space-y-4 mt-0">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-purple-400">Configurações Visuais</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-purple-400">Cores</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-purple-400">Configurações do Botão</h3>

              <div className="space-y-2">
                <Label className="text-muted-foreground text-xs">Borda Arredondada</Label>
                <Select 
                  value={config.buttonBorderRadius} 
                  onValueChange={(v) => updateConfig({ buttonBorderRadius: v as NetvorkConfig["buttonBorderRadius"] })}
                >
                  <SelectTrigger className="bg-secondary/50 border-border">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(v) => updateConfig({ buttonSize: v as NetvorkConfig["buttonSize"] })}
                >
                  <SelectTrigger className="bg-secondary/50 border-border">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(v) => updateConfig({ buttonWidth: v as NetvorkConfig["buttonWidth"] })}
                >
                  <SelectTrigger className="bg-secondary/50 border-border">
                    <SelectValue />
                  </SelectTrigger>
          ...
          <TabsContent value="features" className="p-4 space-y-4 mt-0">
            ...
            <div className="space-y-4">
              ...
              {config.showSocialProof && (
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    <Label className="text-muted-foreground text-xs">Pessoas Visualizando</Label>
                    <Input
                      type="number"
                  ...
                  <div className="space-y-2">
                    <Label className="text-muted-foreground text-xs">Vendas Última Hora</Label>
                    <Input
                      type="number"
          ...
          <TabsContent value="thankyou" className="p-4 space-y-4 mt-0">
            ...
            {config.showThankYouPage && (
              <>
                ...
                <h4 className="text-xs font-semibold text-purple-400">Cores</h4>
                ...
                <div className="flex items-center justify-between">
                  <h4 className="text-xs font-semibold text-purple-400">Detalhes do Pedido</h4>
                  <Switch
                ...
                {config.showOrderDetails && (
                  <div className="space-y-2">
                    <Label className="text-muted-foreground text-xs">Título dos Detalhes</Label>
                    <Input
          ...
          <TabsContent value="upsell" className="p-4 space-y-4 mt-0">
            ...
            {config.showUpsell && (
              <>
                ...
                <h4 className="text-xs font-semibold text-purple-400">Cores do Upsell</h4>
                ...
                <div className="flex items-center justify-between">
                  <Label className="text-muted-foreground text-xs">Mostrar Imagem do Upsell</Label>
                  <Switch
