export type LemonadTheme = "classic" | "neon" | "minimal" | "premium";

export interface LemonadConfig {
  // Theme
  theme: LemonadTheme;
...
export interface LemonadLanguage {
  code: string;
  name: string;
  flag: string;
  title: string;
...
export const LEMONAD_LANGUAGES: Record<string, LemonadLanguage> = {
  RO: {
    code: "RO",
    name: "Română",
    flag: "🇷🇴",
    ...
    socialProofViewing: "Acum pe site sunt",
    socialProofSales: "vânzări în ultima oră",
    socialProofOnline: "online",
    thankYou: {
  ...
  PL: {
    ...
    socialProofViewing: "Obecnie na stronie jest",
    socialProofSales: "sprzedaży w ostatniej godzinie",
    socialProofOnline: "online",
    thankYou: {
  ...
  BR: {
    ...
    socialProofViewing: "Atualmente no site estão",
    socialProofSales: "vendas na última hora",
    socialProofOnline: "online",
    thankYou: {
  ...
  MX: {
    ...
    socialProofViewing: "Actualmente en el sitio hay",
    socialProofSales: "ventas en la última hora",
    socialProofOnline: "en línea",
    thankYou: {
      title: "¡Gracias por tu compra!",
      message: "Tu compra fue procesada con éxito. Pronto te contactaremos para confirmar los detalles.",
      ...
      finalText: "Importante: Mantén tu teléfono cerca. Te contactaremos en 24 horas para confirmar tu compra.",
      contactLabel: "¿Dudas?\nContáctanos:",
    },
  },
  IT: {
    ...
    socialProofViewing: "Attualmente sul sito ci sono",
    socialProofSales: "vendite nell'ultima ora",
    socialProofOnline: "online",
    thankYou: {
  ...
  FR: {
    ...
    socialProofViewing: "Actuellement sur le site il y a",
    socialProofSales: "ventes dans la dernière heure",
    socialProofOnline: "en ligne",
    thankYou: {
  ...
  RU: {
    ...
    disclaimerText: "* Действует на отзывы в рамках канала распространения",
    socialProofViewing: "Сейчас на сайте",
    socialProofSales: "продаж за последний час",
    socialProofOnline: "онлайн",
    thankYou: {
      ...
      statusLabel: "Статус:",
      statusConfirmedText: "✓ Подтверждён",
      ...
      finalText: "Важно: Держите телефон рядом. Мы свяжемся с вами в течение 24 часов для подтверждения покупки.",
      contactLabel: "Вопросы?\nСвяжитесь с нами:",
    },
  },
};

export const getDefaultLemonadConfig = (languageCode: string = "RO"): LemonadConfig => {
