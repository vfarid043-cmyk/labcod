export type TrafficLightTheme = "classic" | "neon" | "minimal" | "premium";
...
export interface TrafficLightLanguage {
  code: string;
  name: string;
  flag: string;
  countryCode: string;
...
export const TRAFFICLIGHT_LANGUAGES: Record<string, TrafficLightLanguage> = {
  RO: {
    code: "RO",
    name: "Română",
    flag: "🇷🇴",
...
export const getDefaultTrafficLightConfig = (languageCode: string = "RO"): TrafficLightConfig => {
