export type WebvorkTheme = "classic" | "neon" | "minimal" | "premium";

export interface WebvorkConfig {
  // Theme
  theme: WebvorkTheme;
...
export interface WebvorkLanguage {
  code: string;
  name: string;
  flag: string;
  countryCode: string;
...
export const WEBVORK_LANGUAGES: Record<string, WebvorkLanguage> = {
  RO: {
    code: "RO",
    name: "Română",
    flag: "🇷🇴",
    ...
    thankYou: {
      ...
      finalText: "Important: Țineți telefonul aproape. Vă vom contacta în următoarele 24 de ore pentru a confirma comanda.",
  ...
  PL: {
    ...
    thankYou: {
      ...
      finalText: "Ważne: Trzymaj telefon w pobliżu. Skontaktujemy się z Tobą w ciągu 24 godzin, aby potwierdzić zamówienie.",
  ...
  MX: {
    ...
    thankYou: {
      ...
      message: "Tu compra ha sido procesada con éxito. Pronto nos pondremos en contacto para confirmar los detalles.",
      ...
      finalText: "Importante: Mantén tu teléfono cerca. Nos comunicaremos en las próximas 24 horas para confirmar tu compra.",
      contactText: "¿Dudas?\nContáctanos:",
    },
  },
  IT: {
    ...
    thankYou: {
      ...
      finalText: "Importante: Tieni il telefono vicino. Ti contatteremo entro 24 ore per confermare l'ordine.",
      contactText: "Domande?\nContattaci:",
    },
  },
  FR: {
    ...
    thankYou: {
      ...
      finalText: "Important: Gardez votre téléphone à proximité. Nous vous contacterons dans les 24 heures pour confirmer votre commande.",
  ...
  RU: {
    ...
    thankYou: {
      ...
      upsellButtonText: "ХОЧУ ПОЛУЧИТЬ",
      finalText: "Важно: Держите телефон рядом. Мы свяжемся с вами в течение 24 часов для подтверждения заказа.",
      contactText: "Вопросы?\nСвяжитесь с нами:",
    },
  },
};

export const getDefaultWebvorkConfig = (languageCode: string = "RO"): WebvorkConfig => {
  const lang = WEBVORK_LANGUAGES[languageCode] || WEBVORK_LANGUAGES.RO;
